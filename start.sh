...
chef-client -j settings.json -z -o recipe['binaryLinks'],recipe['dmg'],recipe['mas'],recipe['cask'],recipe['git'],recipe['tower'],recipe['spectacle'],recipe['spotify'],recipe['nodejs'],recipe['sublime'],recipe['docker'],recipe['zip_app'],recipe['kaleidoscope'],recipe['java'],recipe['eclipse'],recipe['chrome'],recipe['keyboardImprovements'],recipe['skype']
